...
This next chunk isn't strictly necessary. We could skip to the following chunk and replace every instance of "step_00x" with "final_names" and it would still work.
...
# step_001: find people whose first names match others' last names
step_001 <- tibble()

for(i in 1:nrow(final_names)){
  name <- final_names[i,1] %>% as.character()
  if(name %in% final_names$last){
...
Each set of name chains has all of the name chains of one length (in this case, from three names/two people to sixteen names/fifteen people); after the first chain, all subsequent chains build off the previous chain!

```{r name_chains_manual}

# final_names <- readRDS(here("data", clean.output))

# chains_00 - some reasonable starting points
# the people whose last name is also someone else's first name
chains_00 <- tibble()
...
for(i in 1:nrow(chains_00)){
  for(j in 1:nrow(step_001)){
    if(chains_00[i,2] == step_001[j,1]){
      chain[1,][1:2] = chains_00[i,][1:2]
      chain[1,3] = step_001[j,2]
...
for(i in 1:nrow(chains_01)){
  for(j in 1:nrow(step_002)){
    if(chains_01[i,3] == step_002[j,1]){
      chain[1,][1:3] = chains_01[i,][1:3]
      chain[1,4] = step_002[j,2]
...
for(i in 1:nrow(chains_02)){
  for(j in 1:nrow(step_003)){
    if(chains_02[i,4] == step_003[j,1]){
      chain[1,][1:4] = chains_02[i,][1:4]
      chain[1,5] = step_003[j,2]
...
for(i in 1:nrow(chains_03)){
  for(j in 1:nrow(step_004)){
    if(chains_03[i,5] == step_004[j,1]){
      chain[1,][1:5] = chains_03[i,][1:5]
      chain[1,6] = step_004[j,2]
...
for(i in 1:nrow(chains_04)){
  for(j in 1:nrow(step_005)){
    if(chains_04[i,6] == step_005[j,1]){
      chain[1,][1:6] = chains_04[i,][1:6]
      chain[1,7] = step_005[j,2]
...
for(i in 1:nrow(chains_05)){
  for(j in 1:nrow(step_006)){
    if(chains_05[i,7] == step_006[j,1]){
      chain[1,][1:7] = chains_05[i,][1:7]
      chain[1,8] = step_006[j,2]
...
for(i in 1:nrow(chains_06)){
  for(j in 1:nrow(step_007)){
    if(chains_06[i,8] == step_007[j,1]){
      chain[1,][1:8] = chains_06[i,][1:8]
      chain[1,9] = step_007[j,2]
...
for(i in 1:nrow(chains_07)){
  for(j in 1:nrow(step_008)){
    if(chains_07[i,9] == step_008[j,1]){
      chain[1,][1:9] = chains_07[i,][1:9]
      chain[1,10] = step_008[j,2]
...
for(i in 1:nrow(chains_08)){
  for(j in 1:nrow(step_009)){
    if(chains_08[i,10] == step_009[j,1]){
      chain[1,][1:10] = chains_08[i,][1:10]
      chain[1,11] = step_009[j,2]
...
for(i in 1:nrow(chains_09)){
  for(j in 1:nrow(step_010)){
    if(chains_09[i,11] == step_010[j,1]){
      chain[1,][1:11] = chains_09[i,][1:11]
      chain[1,12] = step_010[j,2]
...
for(i in 1:nrow(chains_10)){
  for(j in 1:nrow(step_011)){
    if(chains_10[i,12] == step_011[j,1]){
      chain[1,][1:12] = chains_10[i,][1:12]
      chain[1,13] = step_011[j,2]
...
for(i in 1:nrow(chains_11)){
  for(j in 1:nrow(step_012)){
    if(chains_11[i,13] == step_012[j,1]){
      chain[1,][1:13] = chains_11[i,][1:13]
      chain[1,14] = step_012[j,2]
...
for(i in 1:nrow(chains_12)){
  for(j in 1:nrow(step_013)){
    if(chains_12[i,14] == step_013[j,1]){
      chain[1,][1:14] = chains_12[i,][1:14]
      chain[1,15] = step_013[j,2]
...
for(i in 1:nrow(chains_13)){
  for(j in 1:nrow(step_014)){
    if(chains_13[i,15] == step_014[j,1]){
      chain[1,][1:15] = chains_13[i,][1:15]
      chain[1,16] = step_014[j,2]
...
Future updates:
* Add to the code/name lists without having to re-scrape everything.