...
```{r functions}
# define function - create tibbles until there are no more relevant names
...
# define function - create name chains of a user-defined length
...
# figure this out by running the relevant_names function
# until a data frame of zero observations is created
chain <- tibble() %>%
...
```{r largest_chains, echo = FALSE, eval = TRUE}
knitr::kable(chains_14, format = "markdown")
```
