...
#### 4: STEPS + CHAINS GENERATION ####

## Most of this next chunk isn't strictly necessary
## We could skip to the following chunk and replace every instance of "step_00x" 
## (apart from "step_001," which is necessary) with "final_names" and it would work.

## However, creating tinier and tinier tibbles in this chunk makes the following chunk faster to run
## R only needs to search through a maximum of 1229 rows for name matches 
## as opposed to searching though 4587 rows every time.
...
## Each set of name chains has all of the name chains of one length 
## (in this case, from three names to sixteen names) 
## after the first chain, all subsequent chains build off the previous chain!
